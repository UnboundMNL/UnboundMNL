    ...
    report: async (req, res) => {
        try {
            if (req.session.isLoggedIn) {
                ...
                // TODO: person's member ID
                const memberID = 12345

                // TODO: person's account type
                const accountType = "SEDO"

                // TODO: person's registration date
                const regDate = new Date(2025, 10, 11)

                // TODO: report range
                const reportStartDate = new Date(2024, 0, 1)
                const reportEndDate = new Date(2024, 11, 31)

                // TODO: summary stats
                const totalContrib = 89012
                const totalWithdraw = 35667
                const netBalance = 54445
